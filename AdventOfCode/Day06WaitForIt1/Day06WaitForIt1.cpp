// Day06WaitForIt1.cpp : This file contains the 'main' function. Program execution begins and ends there.
//
...
int main()
{
	...
	for (size_t rId = 0; rId < racesSize; rId++) {
		...
		int time = races[rId];
		int distance = races[rId + racesSize];

		for (int holdButton = 1; holdButton <= time; holdButton++) {
			int traveled = (time - holdButton) * holdButton;
